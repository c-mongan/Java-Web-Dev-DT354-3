...
<html>
    ...
    <body>
	<h1>Symptoms & Consent Questionaire</h1>
	<br><br>
	Notice : To be filled out by the patient
	<br><br>
	Please answer either Yes or No to the below questions
	<br><br>
...
<s:textfield name="consent" label="Do you consent to taking the COVID-19 vaccine?"/>
